...
public class CheckCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String generateCode = generateCode(response);
		System.out.println("checkcode: "+generateCode);
	}
	 ...
	 * @throws IOException
	 */
	public String generateCode(HttpServletResponse response) throws IOException {
		/**
